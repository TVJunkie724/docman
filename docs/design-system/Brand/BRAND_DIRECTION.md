...
- `Sensible Unterlagen, ruhig organisiert`
- `Schnell erfassen, sauber ablegen, wiederfinden`

These are direction phrases, not final marketing copy.
...
- like a cute family scrapbook.
- like a medical app.
- like AI is making decisions silently.
...
No design-system mock may use real private documents, addresses, insurance
numbers, medical facts, school documents, or identity data.

Mocks must use synthetic names, neutral document examples, and privacy-safe
metadata.
