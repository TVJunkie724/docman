...
| `docs/concepts/CONCEPT_F38_ASYNC_PROCESSING_WAIT_EXPERIENCE.md` | Real-state processing, background continuation, Review Queue, calm motion and Reduced Motion; exact phase mock waits for BF-001/BF-013. |
