---
title: "Decision - MVP Quality Gates"
description: "Entscheidung zu verpflichtenden lokalen, R3- und MVP-Quality-Gates fuer DocMan"
tags: [decision, quality-gates, r3, mvp, testing, ci, production-readiness]
lastUpdated: "2026-05-06"
status: "accepted"
---

# Decision - MVP Quality Gates
...
3. **MVP Readiness Gate** fuer den Start echter MVP-Feature-Arbeit und spaeteren MVP-Abschluss.
...
## Gate 3 - MVP Readiness Gate

Vor MVP-Abschluss muessen zusaetzlich gelten:
...
- Desktop-MVP Smoke Build ist gruen.
...
- kritische Bugs fuer Datenverlust, Security, Login/Pairing oder Upload-Verlust sind geschlossen oder bewusst als MVP-blockierend markiert.
- aktive Konzepte/Decisions/Roadmap widersprechen dem implementierten MVP nicht.
...
- F4 nutzt diese Gates fuer Regression und MVP-kritische Flow-Tests.

## Nicht entschieden

- konkrete CI-Runner und GitHub-Actions-Ausgestaltung.
- exakte Microcks-Compose-Datei.
- ob Golden Tests vor MVP verpflichtend werden.
