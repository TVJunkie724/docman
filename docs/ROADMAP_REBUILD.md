...
| C2 Capture, Core Assist and Review Vertical | globales Mobile-/Desktop-Capture, nutzer-/dateibasierte Dokumentgrenzen, dauerhafte asynchrone Verarbeitung sowie konservative Titel-, grobe Typ-/Domain-, einfache Fact-Kandidaten und Case-/Record-Rankings | Happy/Unhappy/Offline/Quota/Restart/Partial-Batch/A11y/Privacy für aktivierte Free/Paid- und Vault-Kombinationen grün; Verarbeitung ändert nie Vault-Autorität und gemischter Inhalt wird nicht semantisch invalidiert |
...
| R8 Facts, Workflows, Catalog and Insights | Facts, Versicherungsabwicklungen, Einreichungsereignisse, Workflows, Abos, Steuer-/Medizin-Slices nur nach ihren Gates | C3 oder spätere aktivierte Slices |
...
| Case-Familienworkshop zuerst vollstaendig im Gespraech, danach Chat-Abgleich und ausdrueckliche Dokumentationsfreigabe; erst dann genau ein Owning Subkonzept, keine Draft-/Workshop-Stubs; Katalog bleibt SSOT fuer ID/Status/Coverage, Subkonzept fuer freigegebenes Verhalten | accepted-governance/open-coverage | `DECISION_INITIAL_CASE_WORKFLOW_CATALOG.md` | Medical und Unfall/Schaden abgedeckt; weitere Familien erst nach Freigabe dokumentieren und vor fachlicher Akzeptanz/Implementierung abdecken |
...
| Small-/Medium-Model Intelligence-Baseline: grobe Klassifikation, typabhaengig vorausgefuellte Metadaten-/Datumsfelder und best-effort Ranking; Vorschlaege werden kompakt bestaetigt, keine autonome Personen-, Kohaerenz-, Workflow-, rechtliche Frist-, Kausalitaets- oder Beziehungswahrheit | accepted-rebaseline | `DECISION_INTELLIGENCE_SCOPE.md` | jede AI-/Capture-/Case-/Document-/Country-/UI-/Backend-Phase; staerkere Klasse nur nach Feasibility |
| Normale Korrekturen sind in M1 weder Trainingsfreigabe noch Analyseverbesserungsprogramm; freiwillige Produktivdatenverbesserung und Wallet-/Karten-/Pass-Slice sind spaetere eigene Gates | accepted-deferred | `DECISION_INTELLIGENCE_SCOPE.md`, `DECISION_DOCUMENT_TYPE_CATALOG.md`, `docs/roadmap/PHASE_INDEX.md` | R15.6/R15.7 |
| Globales Capture im sichtbaren Managed-Subject-Kontext, immer aktive progressive Assist-Verarbeitung, optionale bekannte Typ-/Subtyp-/Fact-/Case-Angaben mit User-Provenienz und verpflichtende Titelvorschlaege | accepted-direction | `DECISION_CAPTURE_FIRST_ASSISTED_ROUTING.md` | C2; exakte Progressive-Disclosure-Controls im UI-Contract |
| Reale nicht blockierende Processing-/Warteerfahrung mit optional frueher grober Extraktion, Case-/Record-Ranking im Hintergrund, stabiler Review Queue, dezenter Animation, Reduced Motion und privacy-sicherer Bereitschaft | accepted-direction | `docs/concepts/CONCEPT_F38_ASYNC_PROCESSING_WAIT_EXPERIENCE.md` | C2; BF-001/BF-013 vor Phase-/Motion-Contract |
| Jede Case-Familie folgt einem verbindlichen Definitions-/Matching-/Lifecycle-/Country-/Handoff-Raster und genau einer Owning Decision | accepted | `DECISION_CASE_FAMILY_DEFINITION_CONTRACT.md` | vor jeder Family-Akzeptanz und Implementation |
...
| Medizinischer Care-Anker, genau ein `part_of`-Kosten-Case je eigenstaendig ausgestellter Rechnung/Honorarnote, Korrektur/Gutschrift/Beleg im selben Cost-Case, wiederholbare Payer-Einreichungen mit null/einem/mehreren Dokumentlinks, dokumentweises Matching mit einem Ankerdokument je neuem verknuepften Medical Case, stets gueltige dokumentunabhaengige Cases, getrennte Zahlungs-/Payer-/Frist-/Lifecycle-Spuren, manueller Care-Abschluss, bestaetigter Cost-Abschluss, unabhaengiger Parent-/Child-Lifecycle, typische optionale Inhalte, eventbasierte Haushaltsfinanzen, Policy Records/Defaults ohne Deckungsberechnung, generische Sonderformulare und optionaler case-lokaler Desktop-Medienarchiv-Randfall | accepted | `DECISION_MEDICAL_CARE_COST_SETTLEMENT_MODEL.md`, `DECISION_CASE_DOCUMENT_RECORD_MODEL.md`, `DECISION_RULE_DERIVED_DEADLINES_REMINDERS.md`, `DECISION_CONTEXTUAL_REVIEW_ACTIONS_FINANCIAL_ROLLUPS.md`, `DECISION_DESKTOP_IMPORT_SCOPE.md` | OQ-011 fuer finalen Dokumentkatalog; WF-01/WF-02/OPS-09 fuer konkrete AT-Regeln |
| Unfall-/Schadenregulierung mit groben Varianten, direktem Medical-Routing ohne leeren Unfall-Wrapper, optionalen Schadenkosten, Case-lokaler Bildsammlung, normalen Versicherungsabwicklungs-Cases, wiederholbaren Einreichungen und Polizzenvorschlaegen ohne Deckungsbehauptung | re-review-required | `DECISION_ACCIDENT_DAMAGE_SETTLEMENT_MODEL.md`, `DECISION_INSURANCE_SETTLEMENT_MODEL.md` | Familien-Re-Review vor C3/R8; OQ-011 sowie WF-01/WF-02 blockieren konkrete Dokument-/AT-/Provider-Details |
...
| Mehrere regelbasierte Fristen je Payer/Provider mit Rule-/Quellenprovenienz, fruehester bestaetigter offener Frist nur als Attention-Wert und ohne stille Neuberechnung | accepted-direction | `DECISION_RULE_DERIVED_DEADLINES_REMINDERS.md` | R8.4; aktive Pack-Regeln erst mit OPS-09 |
| Oesterreichischer Medical-Payer-Stand mit OeGK/SVS/BVAEB, KFA-Registry, getrennten Privatprovider-/Tarifregeln und 42 Monaten nur fuer die drei geprueften gesetzlichen Traeger | accepted-researched-baseline/professional-review-required | `DECISION_AUSTRIA_MEDICAL_PAYER_RULE_PACK.md` | WF-01/WF-02/R8.8/R8.12; Review spaetestens 2027-01-23 |
| Country-/Provider-Regeln erhalten monatlichen Source-Check, mindestens halbjaehrlichen Fachreview, Developer-Reminder, immutable Versionen, Withdrawal und Release-Gate | accepted-direction | `docs/ops/OPS-09_COUNTRY_PROVIDER_RULE_MAINTENANCE.md` | vor erstem aktiven Pack; konkrete CI-/Issue-Automation spaeter umsetzen |
