...
# Mappm - Concept File Quality Matrix

## Rule

`adopted` means the file contains an explicit adoption section for the relevant
enterprise quality contract. It does not change the file's normative status.
Draft/proposed files still require phase-specific review before implementation.
...
| `docs/concepts/CONCEPT_F22_SHELL_AND_NAVIGATION.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F23_COMPONENT_SYSTEM.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F24_FORM_FAMILY.md` | F-concept | draft | adopted | approval before form implementation |
| `docs/concepts/CONCEPT_F25_ACCESSIBILITY_PATTERNS_AND_VISUAL_QA.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F26_BUTTON_FAMILY.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F27_FORM_FIELD_ANATOMY_VALIDATION.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F28_FORM_PICKERS_AND_SELECTION_CONTROLS.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F29_FORM_DATE_TIME_FILE_SCAN_CONTROLS.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F30_FORM_FACTS_LAYOUTS_AND_ASSISTED_REVIEW.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F31_BRAND_SYSTEM_DETAIL.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F32_FOUNDATIONS_TOKENS_TYPOGRAPHY_ICONS.md` | F-concept | accepted | adopted | review before affected phase |
| `docs/concepts/CONCEPT_F33_SHELL_NAVIGATION_AND_WORKSPACE_LAYOUT.md` | F-concept | accepted | adopted | review before affected phase |
...
- Stop if a concept or pillar loses its explicit contract adoption.
- Stop if draft/proposed status is interpreted as implementation approval.
- Stop if a new concept/pillar is added without a matrix row and quality review.
